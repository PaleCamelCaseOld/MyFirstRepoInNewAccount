...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Lab8/css/style.css">
	<!-- <link rel="stylesheet" type="text/css" href=""> -->
	<link rel="shortcut icon" href="/Lab8/img/favicon.png">
...
<body>
	...
	<div class="headers">
		<img src="/Lab8/img/logo_main.png" alt="Тут будет лого">
		...
		<nav class="menu">
			...
			<li><a href="#advice">Советы</a>
				<ul>
					<li><a href="" title="Совет 1">Совет 1</a></li>
					<li><a href="" title="Совет 2">Совет 2</a></li>
	...
	<div class="slider">
		...
		<!-- Первый слайд -->
		<div class="item">
			<img src="/Lab8/img/bg_transform.png">
		</div>

		<!-- Второй слайд -->
		<div class="item">
			<img src="/Lab8/img/bg_two.png">
		</div>
	...
	<div class="containers">
		<div class="leftsidebar">
			...
			<p>
				Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias odio quo enim corrupti nisi necessitatibus provident mollitia qui quaerat dolor tempora vero ipsa dignissimos optio voluptatem, sapiente rem distinctio eaque!
		...
		<table border="2">
			...
			<tbody>
				<tr>
					...
					<td>48</td>
					<td>500</td>
					<td rowspan="4"><a href="#onclick()">Перейти на страницу оплаты</a></td>
				</tr>
				<tr>
	...
	<div class="mapcenters">
		...
		<img class="mapmed" src="/Lab8/img/maps.png" usemap="#medportal">
		<map name="#medportal">
			...
			<area shape="circle" coords="817,629,30" href="https://ru.wikipedia.org/wiki/%D0%93%D0%BE%D0%BC%D0%B5%D0%BB%D1%8C" title="Посмотрите наш медцентр в Гомеле" alt="Гомель" target="_blank">
	...
	<div class="giant">
		<h3 class="headblock">Желаем вам крепкого здоровья!</h3>
	</div>
	<div class="footer">
		...
		<p>Вся информация предоставляется &laquo;Как Есть &raquo;, взята из свободных источников на просторах сети Интернет, используется по лицензии <a href="https://www.gnu.org/licenses/gpl-3.0.html">GNU (GPL) v.3.0</a></p>
